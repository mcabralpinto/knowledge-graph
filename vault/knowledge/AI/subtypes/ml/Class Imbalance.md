...
- Using other [[Performance Metrics|performance metrics]] other than accuracy, especially focusing on per-class evaluation (per-class F1-score, precision, and recall, macro-average F1).
